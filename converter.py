...
addxmlpath = parentpath + 'export_img_data/testpro-PascalVOC-export/Annotations' #"Directory path with XML files"
addimgpath = parentpath + 'export_img_data/testpro-PascalVOC-export/JPEGImages' #"Directory path with IMG files"
outputpath = parentpath + 'preprocessed_data/' #"output folder for yolo format"
classes_txt = parentpath + 'export_img_data/testpro-PascalVOC-export/ImageSets/Main/hand.txt' #"File containing classes"
