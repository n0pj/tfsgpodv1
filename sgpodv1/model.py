...
class Sgpod(object):
    def __init__(self, x, label):
        ...
        print("model-{}.h5".format(datetime.datetime.today()))
    ...
    def model_train(self, x_train, y_train):
        ...
        self.model.save("model-{}.h5".format(datetime.datetime.today()))
        self.model.summary()
    ...
    def sgpod_predict(self, x):
        ...
        model2 = load_model("model-2019-06-05 12:30:26.168393.h5")
